/*! @azure/msal-node v2.5.0 2023-11-07 */
'use strict';
import { CacheManager, AccountEntity, CacheHelpers, AppMetadataEntity, AuthorityMetadataEntity, ThrottlingEntity } from '@azure/msal-common';
